...
"#1":"#0"));return c})};Blockly.Extensions.register("text_indexOf_tooltip",Blockly.Constants.Text.TEXT_INDEXOF_TOOLTIP_EXTENSION);Blockly.Extensions.register("text_quotes",Blockly.Constants.Text.TEXT_QUOTES_EXTENSION);Blockly.Extensions.registerMutator("text_join_mutator",Blockly.Constants.Text.TEXT_JOIN_MUTATOR_MIXIN,Blockly.Constants.Text.TEXT_JOIN_EXTENSION);Blockly.Extensions.registerMutator("text_charAt_mutator",Blockly.Constants.Text.TEXT_CHARAT_MUTATOR_MIXIN,Blockly.Constants.Text.TEXT_CHARAT_EXTENSION);Blockly.Constants.Turtle={};Blockly.Constants.Turtle.HUE=260;
Blockly.defineBlocksWithJsonArray([{type:"spawn_turtle",message0:"spawn_turtle %1",args0:[{type:"input_value",name:"screen"}],output:"Turtle",colour:240,tooltip:"Create a new turtle on the given screen",helpUrl:"https://github.com/walkerje/C-Turtle"},{type:"new_screen",message0:"new display %1 width %2 %3 height %4 %5 title %6",args0:[{type:"input_dummy"},{type:"field_number",name:"width",value:800,min:800,max:1920},{type:"input_dummy"},{type:"field_number",name:"height",value:600,min:600,max:1080},
{type:"input_dummy"},{type:"field_input",name:"title",text:"CxxTurtle"}],output:"Screen",colour:230,tooltip:"Display a new Screen",helpUrl:"https://github.com/walkerje/C-Turtle"},{type:"loadlib",message0:"load %1",args0:[{type:"field_input",name:"library",text:"Turtle.dll"}],nextStatement:null,colour:230,tooltip:"load a dll library",helpUrl:"https://gitee.com/Morphlng/cploxplox/tree/feature%2FDLL/"},{type:"turtle_move",message0:"let %1 move %2 steps %3",args0:[{type:"field_variable",name:"turtle",
variable:"turtle"},{type:"field_number",name:"step",value:10,min:0,max:1E3},{type:"field_dropdown",name:"direction",options:[["forward \u2191","FORWARD"],["backward \u2193","BACKWARD"]]}],previousStatement:null,nextStatement:null,colour:230,tooltip:"let turtle move towards given direction with given steps",helpUrl:"https://github.com/walkerje/C-Turtle"},{type:"turtle_turn",message0:"let %1 turn %2 by %3 \u00b0",args0:[{type:"field_variable",name:"turtle",variable:"turtle"},{type:"field_dropdown",
name:"direction",options:[["right \u2192","RIGHT"],["left \u2190","LEFT"]]},{type:"field_number",name:"degree",value:90,min:0,max:180}],previousStatement:null,nextStatement:null,colour:230,tooltip:"let turtle turn right/left/given degree",helpUrl:"https://github.com/walkerje/C-Turtle"},{type:"turtle_headtoward",message0:"let %1 head towards %2 degree",args0:[{type:"field_variable",name:"turtle",variable:"turtle"},{type:"field_number",name:"DEGREE",value:0,min:-360,max:360}],previousStatement:null,
nextStatement:null,colour:230,tooltip:"set the heading of a turtle",helpUrl:"https://github.com/walkerje/C-Turtle"},{type:"turtle_speed",message0:"set %1 speed to %2",args0:[{type:"field_variable",name:"turtle",variable:"turtle"},{type:"field_dropdown",name:"speed",options:[["slow","SLOW"],["fast","FAST"],["fastest","FASTEST"]]}],previousStatement:null,nextStatement:null,colour:230,tooltip:"modify turtle move speed",helpUrl:"https://github.com/walkerje/C-Turtle"},{type:"turtle_hide",message0:"hide %1",
args0:[{type:"field_variable",name:"turtle",variable:"turtle"}],inputsInline:!0,previousStatement:null,nextStatement:null,colour:230,tooltip:"hide turtle icon",helpUrl:"https://github.com/walkerje/C-Turtle"},{type:"turtle_pencolor",message0:"set %1 's color to %2",args0:[{type:"field_variable",name:"turtle",variable:"turtle"},{type:"field_colour",name:"pencolor",colour:"#ffff00"}],previousStatement:null,nextStatement:null,colour:230,tooltip:"change turtle's pen color",helpUrl:"https://github.com/walkerje/C-Turtle"},
{type:"turtle_pensize",message0:"set %1 's pen size to %2",args0:[{type:"field_variable",name:"turtle",variable:"turtle"},{type:"field_number",name:"SIZE",value:5,min:1,max:1E3}],previousStatement:null,nextStatement:null,colour:230,tooltip:"change turtle's pen size",helpUrl:"https://github.com/walkerje/C-Turtle"},{type:"turtle_show",message0:"show %1",args0:[{type:"field_variable",name:"turtle",variable:"turtle"}],previousStatement:null,nextStatement:null,colour:230,tooltip:"show turtle on screen",
helpUrl:"https://github.com/walkerje/C-Turtle"},{type:"turtle_fillcolor",message0:"set %1 's fill color to %2",args0:[{type:"field_variable",name:"turtle",variable:"turtle"},{type:"field_colour",name:"color",colour:"#33ffff"}],previousStatement:null,nextStatement:null,colour:230,tooltip:"",helpUrl:""},{type:"draw_and_fill",message0:"let %1 %2 draw %3 then fill color",args0:[{type:"field_variable",name:"turtle",variable:"turtle"},{type:"input_dummy"},{type:"input_statement",name:"Drawing"}],previousStatement:null,
nextStatement:null,colour:230,tooltip:"wrap drawing inside begin_fill and end_fill",helpUrl:"https://github.com/walkerje/C-Turtle"}]);Blockly.Blocks.variables={};Blockly.Constants.Variables={};Blockly.Constants.Variables.HUE=330;
